...
def generate_auth_headers(
    ...
    Note on replay protection: Orderly handles replay protection server-side
    via timestamp validation (±5 minute window). No client-side nonce is needed.
    The millisecond timestamp in the signed message provides sufficient uniqueness.
    ...
    # Replay protection: Orderly rejects requests with timestamps >5 min from server time
